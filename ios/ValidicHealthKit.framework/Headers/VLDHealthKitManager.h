 ...
 */
- (void)setSubscriptions:(NSArray<__kindof HKSampleType*> * _Nullable)subscriptions completion:(nullable void(^)(void))completion;
...
/** Turns on processing intraday steps when steps are subscribed to in healthkit.
    This has to be set before calling observeCurrentSubscriptions.
 */
@property (nonatomic, assign) BOOL processIntraday;
